...
struct RecoveryChooserSheet: View {
...
private struct RecoveryCandidateRow: View {
  ...
  private var recoverySubtitle: String {
    ...
    return AppStrings.tr(
      "document.recovery.updated_at",
      source,
      formatter.string(from: candidate.updatedAt)
    )
  }
}

struct DocumentSaveConfirmationSheet: View {
...
struct OutputRequestSheet: View {
