...
@Test("OSSライセンス通知をアプリリソースから読み込める")
func third_party_notices_are_bundled() {
  let notices = KawaCADLicensesPanel.noticeText()
  #expect(notices.contains("Third-party notices"))
  #expect(!notices.contains("Generated by scripts/generate-licenses.mjs"))
}
